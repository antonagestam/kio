...
from kio.schema.alter_partition.v3.response import AlterPartitionResponse
from kio.schema.alter_partition.v3.response import PartitionData
from kio.schema.alter_partition.v3.response import TopicData
...
def test_alter_partition_response_roundtrip(instance: AlterPartitionResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_alter_partition_response(
            buffer.getbuffer(),
        )
