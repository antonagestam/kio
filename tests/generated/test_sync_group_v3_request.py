...
from kio.schema.sync_group.v3.request import SyncGroupRequest
from kio.schema.sync_group.v3.request import SyncGroupRequestAssignment
...
def test_sync_group_request_assignment_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_sync_group_request_assignment(
            buffer.getbuffer(),
        )
...
def test_sync_group_request_roundtrip(instance: SyncGroupRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_sync_group_request(
            buffer.getbuffer(),
        )
