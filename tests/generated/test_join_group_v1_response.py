...
from kio.schema.join_group.v1.response import JoinGroupResponse
from kio.schema.join_group.v1.response import JoinGroupResponseMember
...
def test_join_group_response_member_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_join_group_response_member(
            buffer.getbuffer(),
        )
...
def test_join_group_response_roundtrip(instance: JoinGroupResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_join_group_response(
            buffer.getbuffer(),
        )
