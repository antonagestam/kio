...
from kio.schema.offset_fetch.v9.request import OffsetFetchRequest
from kio.schema.offset_fetch.v9.request import OffsetFetchRequestGroup
from kio.schema.offset_fetch.v9.request import OffsetFetchRequestTopics
...
def test_offset_fetch_request_topics_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_offset_fetch_request_topics(
            buffer.getbuffer(),
        )
...
def test_offset_fetch_request_group_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_offset_fetch_request_group(
            buffer.getbuffer(),
        )
