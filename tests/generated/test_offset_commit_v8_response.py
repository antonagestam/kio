...
from kio.schema.offset_commit.v8.response import OffsetCommitResponse
from kio.schema.offset_commit.v8.response import OffsetCommitResponsePartition
from kio.schema.offset_commit.v8.response import OffsetCommitResponseTopic
