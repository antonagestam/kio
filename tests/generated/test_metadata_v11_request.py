...
from kio.schema.metadata.v11.request import MetadataRequest
from kio.schema.metadata.v11.request import MetadataRequestTopic
...
def test_metadata_request_topic_roundtrip(instance: MetadataRequestTopic) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_metadata_request_topic(
            buffer.getbuffer(),
        )
...
def test_metadata_request_roundtrip(instance: MetadataRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_metadata_request(
            buffer.getbuffer(),
        )
