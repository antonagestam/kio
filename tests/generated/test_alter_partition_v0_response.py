...
from kio.schema.alter_partition.v0.response import AlterPartitionResponse
from kio.schema.alter_partition.v0.response import PartitionData
from kio.schema.alter_partition.v0.response import TopicData
