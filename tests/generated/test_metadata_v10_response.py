...
from kio.schema.metadata.v10.response import MetadataResponse
from kio.schema.metadata.v10.response import MetadataResponseBroker
from kio.schema.metadata.v10.response import MetadataResponsePartition
from kio.schema.metadata.v10.response import MetadataResponseTopic
...
def test_metadata_response_broker_roundtrip(instance: MetadataResponseBroker) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_metadata_response_broker(
            buffer.getbuffer(),
        )
...
def test_metadata_response_partition_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_metadata_response_partition(
            buffer.getbuffer(),
        )
...
def test_metadata_response_topic_roundtrip(instance: MetadataResponseTopic) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_metadata_response_topic(
            buffer.getbuffer(),
        )
...
def test_metadata_response_roundtrip(instance: MetadataResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_metadata_response(
            buffer.getbuffer(),
        )
