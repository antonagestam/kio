...
from kio.schema.join_group.v6.request import JoinGroupRequest
from kio.schema.join_group.v6.request import JoinGroupRequestProtocol
...
def test_join_group_request_protocol_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_join_group_request_protocol(
            buffer.getbuffer(),
        )
...
def test_join_group_request_roundtrip(instance: JoinGroupRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_join_group_request(
            buffer.getbuffer(),
        )
