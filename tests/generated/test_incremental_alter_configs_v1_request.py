...
from kio.schema.incremental_alter_configs.v1.request import AlterableConfig
from kio.schema.incremental_alter_configs.v1.request import AlterConfigsResource
...
def test_alterable_config_roundtrip(instance: AlterableConfig) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_alterable_config(
            buffer.getbuffer(),
        )
...
def test_alter_configs_resource_roundtrip(instance: AlterConfigsResource) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_alter_configs_resource(
            buffer.getbuffer(),
        )
...
def test_incremental_alter_configs_request_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_incremental_alter_configs_request(
            buffer.getbuffer(),
        )
