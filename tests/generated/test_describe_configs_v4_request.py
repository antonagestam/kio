...
from kio.schema.describe_configs.v4.request import DescribeConfigsRequest
from kio.schema.describe_configs.v4.request import DescribeConfigsResource
...
def test_describe_configs_resource_roundtrip(instance: DescribeConfigsResource) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_describe_configs_resource(
            buffer.getbuffer(),
        )
...
def test_describe_configs_request_roundtrip(instance: DescribeConfigsRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_describe_configs_request(
            buffer.getbuffer(),
        )
