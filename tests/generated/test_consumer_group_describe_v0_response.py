...
from kio.schema.consumer_group_describe.v0.response import Assignment
from kio.schema.consumer_group_describe.v0.response import ConsumerGroupDescribeResponse
from kio.schema.consumer_group_describe.v0.response import DescribedGroup
from kio.schema.consumer_group_describe.v0.response import Member
from kio.schema.consumer_group_describe.v0.response import TopicPartitions
...
read_consumer_group_describe_response: Final = entity_reader(
    ConsumerGroupDescribeResponse
)


@pytest.mark.roundtrip
@given(from_type(ConsumerGroupDescribeResponse))
def test_consumer_group_describe_response_roundtrip(
    instance: ConsumerGroupDescribeResponse,
) -> None:
...
@pytest.mark.java
@given(instance=from_type(ConsumerGroupDescribeResponse))
def test_consumer_group_describe_response_java(
    instance: ConsumerGroupDescribeResponse, java_tester: JavaTester
) -> None:
