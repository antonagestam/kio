...
from kio.schema.add_partitions_to_txn.v1.response import AddPartitionsToTxnResponse
from kio.schema.add_partitions_to_txn.v1.response import AddPartitionsToTxnTopicResult
