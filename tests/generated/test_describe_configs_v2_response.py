...
from kio.schema.describe_configs.v2.response import DescribeConfigsResourceResult
from kio.schema.describe_configs.v2.response import DescribeConfigsResponse
from kio.schema.describe_configs.v2.response import DescribeConfigsResult
...
def test_describe_configs_synonym_roundtrip(instance: DescribeConfigsSynonym) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_describe_configs_synonym(
            buffer.getbuffer(),
        )
...
def test_describe_configs_resource_result_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_describe_configs_resource_result(
            buffer.getbuffer(),
        )
...
def test_describe_configs_result_roundtrip(instance: DescribeConfigsResult) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_describe_configs_result(
            buffer.getbuffer(),
        )
...
def test_describe_configs_response_roundtrip(instance: DescribeConfigsResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_describe_configs_response(
            buffer.getbuffer(),
        )
