...
from kio.schema.create_acls.v3.request import AclCreation
from kio.schema.create_acls.v3.request import CreateAclsRequest
...
def test_acl_creation_roundtrip(instance: AclCreation) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_acl_creation(
            buffer.getbuffer(),
        )
...
def test_create_acls_request_roundtrip(instance: CreateAclsRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_create_acls_request(
            buffer.getbuffer(),
        )
