...
from kio.schema.offset_commit.v9.response import OffsetCommitResponse
from kio.schema.offset_commit.v9.response import OffsetCommitResponsePartition
from kio.schema.offset_commit.v9.response import OffsetCommitResponseTopic
