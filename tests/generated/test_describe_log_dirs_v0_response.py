...
from kio.schema.describe_log_dirs.v0.response import DescribeLogDirsPartition
from kio.schema.describe_log_dirs.v0.response import DescribeLogDirsResponse
from kio.schema.describe_log_dirs.v0.response import DescribeLogDirsResult
from kio.schema.describe_log_dirs.v0.response import DescribeLogDirsTopic
...
def test_describe_log_dirs_partition_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_describe_log_dirs_partition(
            buffer.getbuffer(),
        )
...
def test_describe_log_dirs_topic_roundtrip(instance: DescribeLogDirsTopic) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_describe_log_dirs_topic(
            buffer.getbuffer(),
        )
...
def test_describe_log_dirs_result_roundtrip(instance: DescribeLogDirsResult) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_describe_log_dirs_result(
            buffer.getbuffer(),
        )
...
def test_describe_log_dirs_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_describe_log_dirs_response(
            buffer.getbuffer(),
        )
