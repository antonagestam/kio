...
from kio.schema.alter_partition.v2.request import AlterPartitionRequest
from kio.schema.alter_partition.v2.request import PartitionData
from kio.schema.alter_partition.v2.request import TopicData
