...
from kio.schema.offset_fetch.v3.response import OffsetFetchResponse
from kio.schema.offset_fetch.v3.response import OffsetFetchResponsePartition
from kio.schema.offset_fetch.v3.response import OffsetFetchResponseTopic
