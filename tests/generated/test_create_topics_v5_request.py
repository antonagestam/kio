...
from kio.schema.create_topics.v5.request import CreatableReplicaAssignment
from kio.schema.create_topics.v5.request import CreatableTopic
from kio.schema.create_topics.v5.request import CreateableTopicConfig
from kio.schema.create_topics.v5.request import CreateTopicsRequest
...
def test_creatable_replica_assignment_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_creatable_replica_assignment(
            buffer.getbuffer(),
        )
...
def test_createable_topic_config_roundtrip(instance: CreateableTopicConfig) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_createable_topic_config(
            buffer.getbuffer(),
        )
...
def test_creatable_topic_roundtrip(instance: CreatableTopic) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_creatable_topic(
            buffer.getbuffer(),
        )
...
def test_create_topics_request_roundtrip(instance: CreateTopicsRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_create_topics_request(
            buffer.getbuffer(),
        )
