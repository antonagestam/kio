...
from kio.schema.add_partitions_to_txn.v2.request import AddPartitionsToTxnRequest
from kio.schema.add_partitions_to_txn.v2.request import AddPartitionsToTxnTopic
