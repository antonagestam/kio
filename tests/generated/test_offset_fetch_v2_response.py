...
from kio.schema.offset_fetch.v2.response import OffsetFetchResponse
from kio.schema.offset_fetch.v2.response import OffsetFetchResponsePartition
from kio.schema.offset_fetch.v2.response import OffsetFetchResponseTopic
