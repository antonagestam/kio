...
from kio.schema.produce.v10.response import BatchIndexAndErrorMessage
from kio.schema.produce.v10.response import LeaderIdAndEpoch
from kio.schema.produce.v10.response import NodeEndpoint
from kio.schema.produce.v10.response import PartitionProduceResponse
from kio.schema.produce.v10.response import ProduceResponse
from kio.schema.produce.v10.response import TopicProduceResponse
...
def test_batch_index_and_error_message_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_batch_index_and_error_message(
            buffer.getbuffer(),
        )
...
def test_partition_produce_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_partition_produce_response(
            buffer.getbuffer(),
        )
...
def test_topic_produce_response_roundtrip(instance: TopicProduceResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_topic_produce_response(
            buffer.getbuffer(),
        )
...
def test_node_endpoint_roundtrip(instance: NodeEndpoint) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_node_endpoint(
            buffer.getbuffer(),
        )
...
def test_produce_response_roundtrip(instance: ProduceResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_produce_response(
            buffer.getbuffer(),
        )
