...
def test_writable_txn_marker_partition_result_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        remaining, result = read_writable_txn_marker_partition_result(
            buffer.getbuffer(),
        )
...
def test_writable_txn_marker_topic_result_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_writable_txn_marker_topic_result(
            buffer.getbuffer(),
        )
...
def test_writable_txn_marker_result_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_writable_txn_marker_result(
            buffer.getbuffer(),
        )
...
def test_write_txn_markers_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_write_txn_markers_response(
            buffer.getbuffer(),
        )
