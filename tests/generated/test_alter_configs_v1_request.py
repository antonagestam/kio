...
from kio.schema.alter_configs.v1.request import AlterableConfig
from kio.schema.alter_configs.v1.request import AlterConfigsRequest
...
def test_alter_configs_request_roundtrip(instance: AlterConfigsRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        remaining, result = read_alter_configs_request(
            buffer.getbuffer(),
        )
